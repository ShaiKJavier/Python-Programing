...
while True:   #while is loop used when multiple conditions used
    human_action = input("enter the choice you want(rock,paper,scissors):") #user actions are enter by the user
    ...
    play_again = input("play again?click(yes/no):") #you want to play again click yes means yes or no means no
